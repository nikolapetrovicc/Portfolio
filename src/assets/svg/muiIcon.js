...
const muiIcon = () => {
  return (
    <svg viewBox="0 0 2249 2249" xmlns="http://www.w3.org/2000/svg" {...props}>
      <path
      ...
      />
      <path
        d="m2065.4 1170.4 165 95.3-165 95.3-253.2-146.2V922.5l253.2-146.2 153.4 88.6c15.6 65.8 25.1 132.9 28.6 200.5l-93.8 54.2v-101.8l-88.2-50.9-88.2 50.9v101.8z"
        fill="#333"
      />
      <path
      ...
      <path
        ...
        fill="#333"
      />
      <path d="m815 776.2 253.2 438.5L815 1360.9 561.9 922.4z" fill="#6da75d" />
      <path d="m561.9 1214.8 86.9-141.8-86.9-150.6z" fill="#55a344" />
      <path d="m983.8 1068.6 84.4-146.2-253.1-146.1z" fill="#639d57" />
      <path
        d="M1522.3 437.4v387.9l-84.9-49-253.2 146.2v292.4l253.2 146.2 253.2-146.2V527.5zm-.5 679.9-84.4 48.7-84.4-48.7v-97.4l84.4-48.7 84.4 48.7z"
        fill="#333"
      />
      <g fill="#66a060">
